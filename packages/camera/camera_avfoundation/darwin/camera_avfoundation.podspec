...
A Flutter plugin to use the camera from your Flutter app.
  ...
  s.source           = { :http => 'https://github.com/flutter/packages/tree/main/packages/camera/camera_avfoundation' }
  ...
  s.resource_bundles = {
    'camera_avfoundation_privacy' => [
      'camera_avfoundation/Sources/camera_avfoundation/Resources/PrivacyInfo.xcprivacy'
    ]
  }
end